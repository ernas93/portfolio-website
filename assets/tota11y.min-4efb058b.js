(function(){const L=document.createElement("link").relList;if(L&&L.supports&&L.supports("modulepreload"))return;for(const h of document.querySelectorAll('link[rel="modulepreload"]'))v(h);new MutationObserver(h=>{for(const R of h)if(R.type==="childList")for(const W of R.addedNodes)W.tagName==="LINK"&&W.rel==="modulepreload"&&v(W)}).observe(document,{childList:!0,subtree:!0});function x(h){const R={};return h.integrity&&(R.integrity=h.integrity),h.referrerPolicy&&(R.referrerPolicy=h.referrerPolicy),h.crossOrigin==="use-credentials"?R.credentials="include":h.crossOrigin==="anonymous"?R.credentials="omit":R.credentials="same-origin",R}function v(h){if(h.ep)return;h.ep=!0;const R=x(h);fetch(h.href,R)}})();const Hr="/portfolio-website/assets/nala2-534a3ab3.jpeg";(()=>{const q=document.querySelector("#nala");q&&q.addEventListener("click",()=>{const L=document.createElement("img");L.src=Hr,L.style.height="100%",L.style.position="fixed",L.style.top=0,L.style.left=0,document.body.appendChild(L),setTimeout(()=>{document.body.removeChild(L)},2e3)})})();/*!
 * tota11y v0.1.6
 ...
 * Date: 2016-10-03
 * 
 */(function(q){function L(v){if(x[v])return x[v].exports;var h=x[v]={exports:{},id:v,loaded:!1};return q[v].call(h.exports,h,h.exports,L),h.loaded=!0,h.exports}var x={};return L.m=q,L.c=x,L.p="",L(0)})([function(q,L,x){(function(v){function h(j,O){if(!(j instanceof O))throw new TypeError("Cannot call a class as a function")}var R=function(){function j(O,k){for(var _=0;_<k.length;_++){var u=k[_];u.enumerable=u.enumerable||!1,u.configurable=!0,"value"in u&&(u.writable=!0),Object.defineProperty(O,u.key,u)}}return function(O,k,_){return k&&j(O.prototype,k),_&&j(O,_),O}}();x(43);var W=x(1),P=x(17),d=x(35);x(42);var F=function(){function j(){h(this,j),this.activePlugin=null}return R(j,[{key:"handlePluginClick",value:function(O){O===this.activePlugin?(O.deactivate(),this.activePlugin=null):(this.activePlugin&&this.activePlugin.deactivate(),O.activate(),this.activePlugin=O)}},{key:"appendTo",value:function(O){var k=this,_=W(d()),u=void 0,c=P.default.map(function(T){return v(T,{onClick:k.handlePluginClick.bind(k)})}),g=null;P.experimental.length&&(g=v("li",null,v("div",{className:"tota11y-plugins-separator"},"Experimental"),v("ul",null,P.experimental.map(function(T){return v(T,{onClick:k.handlePluginClick.bind(k)})}))));var A=v("ul",{className:"tota11y-plugins"},c,g),w=function(T){T.preventDefault(),T.stopPropagation(),u.toggleClass("tota11y-expanded"),u.attr("aria-expanded",u.is(".tota11y-expanded"))},D=v("button",{"aria-controls":"tota11y-toolbar",className:"tota11y-toolbar-toggle",onClick:w,"aria-label":"[tota11y] Toggle menu"},v("div",{"aria-hidden":"true",className:"tota11y-toolbar-logo"},_));u=v("div",{id:"tota11y-toolbar",className:"tota11y tota11y-toolbar",role:"region","aria-expanded":"false"},v("div",{className:"tota11y-toolbar-body"},A),D),O.append(u)}}]),j}();W(function(){var j=new F;j.appendTo(W("body"))})}).call(L,x(4))},function(q,L,x){var v,h;/*!
...
`)}}()},,function(q,L){function x(h,R){var W=R&&R.loc,P=void 0,d=void 0;W&&(P=W.start.line,d=W.start.column,h+=" - "+P+":"+d);for(var F=Error.prototype.constructor.call(this,h),j=0;j<v.length;j++)this[v[j]]=F[v[j]];Error.captureStackTrace&&Error.captureStackTrace(this,x),W&&(this.lineNumber=P,this.column=d)}L.__esModule=!0;var v=["description","fileName","lineNumber","message","name","number","stack"];x.prototype=new Error,L.default=x,q.exports=L.default},function(q,L){function x(c){return F[c]}function v(c){for(var g=1;g<arguments.length;g++)for(var A in arguments[g])Object.prototype.hasOwnProperty.call(arguments[g],A)&&(c[A]=arguments[g][A]);return c}function h(c,g){for(var A=0,w=c.length;w>A;A++)if(c[A]===g)return A;return-1}function R(c){if(typeof c!="string"){if(c&&c.toHTML)return c.toHTML();if(c==null)return"";if(!c)return c+"";c=""+c}return O.test(c)?c.replace(j,x):c}function W(c){return c||c===0?!(!u(c)||c.length!==0):!0}function P(c,g){return c.path=g,c}function d(c,g){return(c?c+".":"")+g}L.__esModule=!0,L.extend=v,L.indexOf=h,L.escapeExpression=R,L.isEmpty=W,L.blockParams=P,L.appendContextPath=d;var F={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;"},j=/[&<>"'`]/g,O=/[&<>"'`]/,k=Object.prototype.toString;L.toString=k;var _=function(c){return typeof c=="function"};_(/x/)&&(L.isFunction=_=function(c){return typeof c=="function"&&k.call(c)==="[object Function]"});var _;L.isFunction=_;var u=Array.isArray||function(c){return c&&typeof c=="object"?k.call(c)==="[object Array]":!1};L.isArray=u},function(q,L){function x(){return axs.AuditRules.getRules().map(function(W){return W.name})}function v(W){var P=new axs.AuditConfiguration;return P.showUnsupportedRulesWarning=!1,P.ignoreSelectors(W,".tota11y *"),x().forEach(function(d){d!==W&&P.ignoreSelectors(d,"*")}),P}function h(){axs.AuditRule.collectMatchingElements=function(W,P,d,F){if(W.nodeType===Node.ELEMENT_NODE)var j=W;if(j&&P.call(null,j)&&d.push(j),j){var O=j.shadowRoot||j.webkitShadowRoot;if(O)return void axs.AuditRule.collectMatchingElements(O,P,d,O)}if(j&&j.localName=="content")for(var k=j,_=k.getDistributedNodes(),u=0;u<_.length;u++)axs.AuditRule.collectMatchingElements(_[u],P,d,F);else{if(j&&j.localName=="shadow"){var c=j;if(F)for(var _=c.getDistributedNodes(),u=0;u<_.length;u++)axs.AuditRule.collectMatchingElements(_[u],P,d,F);else console.warn("ShadowRoot not provided for",j)}for(var g=W.firstChild;g!=null;)axs.AuditRule.collectMatchingElements(g,P,d,F),g=g.nextSibling}}}function R(W){var P=v(W);return h(),axs.Audit.run(P).filter(function(d){return d.rule.name===W})[0]}q.exports=R},function(q,L,x){function v(T,b){this.helpers=T||{},this.partials=b||{},h(this)}function h(T){T.registerHelper("helperMissing",function(){if(arguments.length!==1)throw new j.default('Missing helper: "'+arguments[arguments.length-1].name+'"')}),T.registerHelper("blockHelperMissing",function(b,E){var M=E.inverse,Y=E.fn;if(b===!0)return Y(this);if(b===!1||b==null)return M(this);if(u(b))return b.length>0?(E.ids&&(E.ids=[E.name]),T.helpers.each(b,E)):M(this);if(E.data&&E.ids){var ee=R(E.data);ee.contextPath=d.appendContextPath(E.data.contextPath,E.name),E={data:ee}}return Y(b,E)}),T.registerHelper("each",function(b,E){function M(He,ct,Et){be&&(be.key=He,be.index=ct,be.first=ct===0,be.last=!!Et,ze&&(be.contextPath=ze+He)),pe+=Y(b[He],{data:be,blockParams:d.blockParams([b[He],He],[ze+He,null])})}if(!E)throw new j.default("Must pass iterator to #each");var Y=E.fn,ee=E.inverse,ae=0,pe="",be=void 0,ze=void 0;if(E.data&&E.ids&&(ze=d.appendContextPath(E.data.contextPath,E.ids[0])+"."),c(b)&&(b=b.call(this)),E.data&&(be=R(E.data)),b&&typeof b=="object")if(u(b))for(var ut=b.length;ut>ae;ae++)M(ae,ae,ae===b.length-1);else{var ke=void 0;for(var rt in b)b.hasOwnProperty(rt)&&(ke&&M(ke,ae-1),ke=rt,ae++);ke&&M(ke,ae-1,!0)}return ae===0&&(pe=ee(this)),pe}),T.registerHelper("if",function(b,E){return c(b)&&(b=b.call(this)),!E.hash.includeZero&&!b||d.isEmpty(b)?E.inverse(this):E.fn(this)}),T.registerHelper("unless",function(b,E){return T.helpers.if.call(this,b,{fn:E.inverse,inverse:E.fn,hash:E.hash})}),T.registerHelper("with",function(b,E){c(b)&&(b=b.call(this));var M=E.fn;if(d.isEmpty(b))return E.inverse(this);if(E.data&&E.ids){var Y=R(E.data);Y.contextPath=d.appendContextPath(E.data.contextPath,E.ids[0]),E={data:Y}}return M(b,E)}),T.registerHelper("log",function(b,E){var M=E.data&&E.data.level!=null?parseInt(E.data.level,10):1;T.log(M,b)}),T.registerHelper("lookup",function(b,E){return b&&b[E]})}function R(T){var b=d.extend({},T);return b._parent=T,b}var W=function(T){return T&&T.__esModule?T:{default:T}};L.__esModule=!0,L.HandlebarsEnvironment=v,L.createFrame=R;var P=x(10),d=W(P),F=x(9),j=W(F),O="3.0.1";L.VERSION=O;var k=6;L.COMPILER_REVISION=k;var _={1:"<= 1.0.rc.2",2:"== 1.0.0-rc.3",3:"== 1.0.0-rc.4",4:"== 1.x.x",5:"== 2.0.0-alpha.x",6:">= 2.0.0-beta.1"};L.REVISION_CHANGES=_;var u=d.isArray,c=d.isFunction,g=d.toString,A="[object Object]";v.prototype={constructor:v,logger:w,log:D,registerHelper:function(T,b){if(g.call(T)===A){if(b)throw new j.default("Arg not supported with multiple helpers");d.extend(this.helpers,T)}else this.helpers[T]=b},unregisterHelper:function(T){delete this.helpers[T]},registerPartial:function(T,b){if(g.call(T)===A)d.extend(this.partials,T);else{if(typeof b>"u")throw new j.default("Attempting to register a partial as undefined");this.partials[T]=b}},unregisterPartial:function(T){delete this.partials[T]}};var w={methodMap:{0:"debug",1:"info",2:"warn",3:"error"},DEBUG:0,INFO:1,WARN:2,ERROR:3,level:1,log:function(T,b){if(typeof console<"u"&&w.level<=T){var E=w.methodMap[T];(console[E]||console.log).call(console,b)}}};L.logger=w;var D=w.log;L.log=D},function(q,L,x){(function(v){function h(O,k){if(!(O instanceof k))throw new TypeError("Cannot call a class as a function")}function R(O,k){if(typeof k!="function"&&k!==null)throw new TypeError("Super expression must either be null or a function, not "+typeof k);O.prototype=Object.create(k&&k.prototype,{constructor:{value:O,enumerable:!1,writable:!0,configurable:!0}}),k&&(Object.setPrototypeOf?Object.setPrototypeOf(O,k):O.__proto__=k)}var W=function(){function O(k,_){for(var u=0;u<_.length;u++){var c=_[u];c.enumerable=c.enumerable||!1,c.configurable=!0,"value"in c&&(c.writable=!0),Object.defineProperty(k,c.key,c)}}return function(k,_,u){return _&&O(k.prototype,_),u&&O(k,u),k}}(),P=function(O,k,_){for(var u=!0;u;){var c=O,g=k,A=_;u=!1,c===null&&(c=Function.prototype);var w=Object.getOwnPropertyDescriptor(c,g);if(w!==void 0){if("value"in w)return w.value;var D=w.get;return D===void 0?void 0:D.call(A)}var T=Object.getPrototypeOf(c);if(T===null)return;O=T,k=g,_=A,u=!0,w=T=void 0}},d=x(1),F=x(2);x(44);var j=function(O){function k(){h(this,k),P(Object.getPrototypeOf(k.prototype),"constructor",this).apply(this,arguments)}return R(k,O),W(k,[{key:"getTitle",value:function(){return"Screen Reader Wand"}},{key:"getDescription",value:function(){return"Hover over elements to view them as a screen reader would"}},{key:"run",value:function(){this.summary(" "),this.panel.render(),d(document).on("mousemove.wand",function(_){var u=document.elementFromPoint(_.clientX,_.clientY),c=axs.properties.findTextAlternatives(u,{});d(".tota11y-outlined").removeClass("tota11y-outlined"),d(u).addClass("tota11y-outlined"),c?d(".tota11y-info-section.active").text(c):d(".tota11y-info-section.active").html(v("i",{className:"tota11y-nothingness"},"No text visible to a screen reader"))})}},{key:"cleanup",value:function(){d(".tota11y-outlined").removeClass("tota11y-outlined"),d(document).off("mousemove.wand")}}]),k}(F);q.exports=j}).call(L,x(4))},function(q,L,x){(function(v){function h(_,u){if(!(_ instanceof u))throw new TypeError("Cannot call a class as a function")}function R(_,u){if(typeof u!="function"&&u!==null)throw new TypeError("Super expression must either be null or a function, not "+typeof u);_.prototype=Object.create(u&&u.prototype,{constructor:{value:_,enumerable:!1,writable:!0,configurable:!0}}),u&&(Object.setPrototypeOf?Object.setPrototypeOf(_,u):_.__proto__=u)}var W=function(){function _(u,c){for(var g=0;g<c.length;g++){var A=c[g];A.enumerable=A.enumerable||!1,A.configurable=!0,"value"in A&&(A.writable=!0),Object.defineProperty(u,A.key,A)}}return function(u,c,g){return c&&_(u.prototype,c),g&&_(u,g),u}}(),P=function(_,u,c){for(var g=!0;g;){var A=_,w=u,D=c;g=!1,A===null&&(A=Function.prototype);var T=Object.getOwnPropertyDescriptor(A,w);if(T!==void 0){if("value"in T)return T.value;var b=T.get;return b===void 0?void 0:b.call(D)}var E=Object.getPrototypeOf(A);if(E===null)return;_=E,u=w,c=D,g=!0,T=E=void 0}},d=x(1),F=x(2),j=x(3)("alt-text"),O=x(11),k=function(_){function u(){h(this,u),P(Object.getPrototypeOf(u.prototype),"constructor",this).apply(this,arguments)}return R(u,_),W(u,[{key:"getTitle",value:function(){return"Image alt-text"}},{key:"getDescription",value:function(){return"Annotates images without alt text"}},{key:"reportError",value:function(c){var g=d(c),A=g.attr("src")||"..",w="Image is missing alt text",D=v("div",null,v("p",null,'This image does not have an associated "alt" attribute. Please specify the alt text for this image like so:'),v("pre",null,v("code",null,'&lt;img src="'+A+'" alt="Image description"&gt')),v("p",null,'If the image is decorative and does not convey any information to the surrounding content, however, you may leave this "alt" attribute empty, or specify a "role" attribute with a value of "presentation."'),v("pre",null,v("code",null,'&lt;img src="'+A+'" alt=""&gt;',v("br",null),'&lt;img src="'+A+'" role="presentation"&gt;'))),T=this.error(w,D,g);j.errorLabel(g,"",w,T)}},{key:"run",value:function(){var c=O("imagesWithoutAltText"),g=c.result,A=c.elements;g==="FAIL"&&A.forEach(this.reportError.bind(this)),d('img[role="presentation"], img[alt=""]').each(function(w,D){j.errorLabel(d(D),"","This image is decorative").addClass("tota11y-label-warning")})}},{key:"cleanup",value:function(){j.removeAll()}}]),u}(F);q.exports=k}).call(L,x(4))},function(q,L,x){function v(_,u){if(!(_ instanceof u))throw new TypeError("Cannot call a class as a function")}function h(_,u){if(typeof u!="function"&&u!==null)throw new TypeError("Super expression must either be null or a function, not "+typeof u);_.prototype=Object.create(u&&u.prototype,{constructor:{value:_,enumerable:!1,writable:!0,configurable:!0}}),u&&(Object.setPrototypeOf?Object.setPrototypeOf(_,u):_.__proto__=u)}var R=function(){function _(u,c){for(var g=0;g<c.length;g++){var A=c[g];A.enumerable=A.enumerable||!1,A.configurable=!0,"value"in A&&(A.writable=!0),Object.defineProperty(u,A.key,A)}}return function(u,c,g){return c&&_(u.prototype,c),g&&_(u,g),u}}(),W=function(_,u,c){for(var g=!0;g;){var A=_,w=u,D=c;g=!1,A===null&&(A=Function.prototype);var T=Object.getOwnPropertyDescriptor(A,w);if(T!==void 0){if("value"in T)return T.value;var b=T.get;return b===void 0?void 0:b.call(D)}var E=Object.getPrototypeOf(A);if(E===null)return;_=E,u=w,c=D,g=!0,T=E=void 0}},P=x(1),d=x(2),F=x(3)("contrast"),j=x(30),O=x(29);x(45);var k=function(_){function u(){v(this,u),W(Object.getPrototypeOf(u.prototype),"constructor",this).call(this),this.preservedColors=[]}return h(u,_),R(u,[{key:"getTitle",value:function(){return"Contrast"}},{key:"getDescription",value:function(){return"Labels elements with insufficient contrast"}},{key:"addError",value:function(c,g){var A=c.style,w=c.fgColor,D=c.bgColor,T=c.contrastRatio,b=c.requiredRatio,E=axs.color.suggestColors(D,w,{AA:b}).AA,M={fgColorHex:axs.color.colorToString(w),bgColorHex:axs.color.colorToString(D),contrastRatio:T,requiredRatio:b,suggestedFgColorHex:E.fg,suggestedBgColorHex:E.bg,suggestedColorsRatio:E.contrast},Y=P(O(M)),ee=A.color,ae=A.backgroundColor;return Y.find(".preview-contrast-fix").click(function(pe){P(pe.target).prop("checked")?(P(g).css("color",E.fg),P(g).css("background-color",E.bg)):(P(g).css("color",ee),P(g).css("background-color",ae))}),this.error(j(M),Y,P(g))}},{key:"run",value:function(){var c=this,g={};P("*").each(function(A,w){if(axs.properties.hasDirectTextDescendant(w)&&!(P(w).parents(".tota11y").length>0||axs.utils.elementIsTransparent(w)||axs.utils.elementHasZeroArea(w))){var D=getComputedStyle(w),T=axs.utils.getBgColor(D,w),b=axs.utils.getFgColor(D,w,T),E=axs.color.calculateContrastRatio(b,T).toFixed(2),M=axs.utils.isLargeFont(D)?3:4.5,Y=axs.color.colorToString(b)+"/"+axs.color.colorToString(T)+"/"+M;if(axs.utils.isLowContrast(E,D)){if(!g[Y]){var ee=c.addError({style:D,fgColor:b,bgColor:T,contrastRatio:E,requiredRatio:M},w);c.preservedColors.push({$el:P(w),fg:D.color,bg:D.backgroundColor}),g[Y]=ee}F.errorLabel(P(w),E,"This contrast is insufficient at this size.",g[Y])}else g[Y]||(F.label(P(w),E).addClass("tota11y-label-success"),g[Y]=!0)}})}},{key:"cleanup",value:function(){this.preservedColors.forEach(function(c){c.$el.css("color",c.fg),c.$el.css("background-color",c.bg)}),F.removeAll()}}]),u}(d);q.exports=k},function(q,L,x){(function(v){function h(u,c){if(!(u instanceof c))throw new TypeError("Cannot call a class as a function")}function R(u,c){if(typeof c!="function"&&c!==null)throw new TypeError("Super expression must either be null or a function, not "+typeof c);u.prototype=Object.create(c&&c.prototype,{constructor:{value:u,enumerable:!1,writable:!0,configurable:!0}}),c&&(Object.setPrototypeOf?Object.setPrototypeOf(u,c):u.__proto__=c)}var W=function(){function u(c,g){for(var A=0;A<g.length;A++){var w=g[A];w.enumerable=w.enumerable||!1,w.configurable=!0,"value"in w&&(w.writable=!0),Object.defineProperty(c,w.key,w)}}return function(c,g,A){return g&&u(c.prototype,g),A&&u(c,A),c}}(),P=function(u,c,g){for(var A=!0;A;){var w=u,D=c,T=g;A=!1,w===null&&(w=Function.prototype);var b=Object.getOwnPropertyDescriptor(w,D);if(b!==void 0){if("value"in b)return b.value;var E=b.get;return E===void 0?void 0:E.call(T)}var M=Object.getPrototypeOf(w);if(M===null)return;u=M,c=D,g=T,A=!0,b=M=void 0}},d=x(1),F=x(2),j=x(3)("headings"),O=x(31);x(46);var k={FIRST_NOT_H1:function(u){return{title:"First heading is not an &lt;h1&gt;",description:`
    ...
    <div class="tota11y-contrast-suggestion">
        <span class="tota11y-color-hexes">
            `+O((d=(d=R.suggestedFgColorHex||(h!=null?h.suggestedFgColorHex:h))!=null?d:F,typeof d===j?d.call(h,{name:"suggestedFgColorHex",hash:{},data:P}):d))+"/"+O((d=(d=R.suggestedBgColorHex||(h!=null?h.suggestedBgColorHex:h))!=null?d:F,typeof d===j?d.call(h,{name:"suggestedBgColorHex",hash:{},data:P}):d))+`
        </span>

        <span class="tota11y-swatches">
            <span
                class="tota11y-swatch"
                style="background-color: `+O((d=(d=R.suggestedFgColorHex||(h!=null?h.suggestedFgColorHex:h))!=null?d:F,typeof d===j?d.call(h,{name:"suggestedFgColorHex",hash:{},data:P}):d))+` !important">
            </span>
            /
            <span
                class="tota11y-swatch"
                style="background-color: `+O((d=(d=R.suggestedBgColorHex||(h!=null?h.suggestedBgColorHex:h))!=null?d:F,typeof d===j?d.call(h,{name:"suggestedBgColorHex",hash:{},data:P}):d))+` !important">
            </span>
        </span>

        has a ratio of <strong>`+O((d=(d=R.suggestedColorsRatio||(h!=null?h.suggestedColorsRatio:h))!=null?d:F,typeof d===j?d.call(h,{name:"suggestedColorsRatio",hash:{},data:P}):d))+`</strong>
        <br />
...
`},useData:!0})},function(q,L,x){var v=x(6);q.exports=(v.default||v).template({compiler:[6,">= 2.0.0-beta.1"],main:function(h,R,W,P){var d,F=R.helperMissing,j="function",O=this.escapeExpression;return"Insufficient contrast ratio ("+O((d=(d=R.contrastRatio||(h!=null?h.contrastRatio:h))!=null?d:F,typeof d===j?d.call(h,{name:"contrastRatio",hash:{},data:P}):d))+" &lt; "+O((d=(d=R.requiredRatio||(h!=null?h.requiredRatio:h))!=null?d:F,typeof d===j?d.call(h,{name:"requiredRatio",hash:{},data:P}):d))+`)

<span class="tota11y-swatches">
    <span class="tota11y-swatch" style="background-color: `+O((d=(d=R.fgColorHex||(h!=null?h.fgColorHex:h))!=null?d:F,typeof d===j?d.call(h,{name:"fgColorHex",hash:{},data:P}):d))+` !important"></span>
    /
    <span class="tota11y-swatch" style="background-color: `+O((d=(d=R.bgColorHex||(h!=null?h.bgColorHex:h))!=null?d:F,typeof d===j?d.call(h,{name:"bgColorHex",hash:{},data:P}):d))+` !important"></span>
</span>
`},useData:!0})},function(q,L,x){var v=x(6);q.exports=(v.default||v).template({compiler:[6,">= 2.0.0-beta.1"],main:function(h,R,W,P){var d,F=R.helperMissing,j="function",O=this.escapeExpression;return'<div class="tota11y-heading-outline-entry heading-level-'+O((d=(d=R.level||(h!=null?h.level:h))!=null?d:F,typeof d===j?d.call(h,{name:"level",hash:{},data:P}):d))+`">
    <span class="tota11y-heading-outline-level tota11y-label">`+O((d=(d=R.level||(h!=null?h.level:h))!=null?d:F,typeof d===j?d.call(h,{name:"level",hash:{},data:P}):d))+`</span>
    <span class="tota11y-heading-outline-heading-text">`+O((d=(d=R.text||(h!=null?h.text:h))!=null?d:F,typeof d===j?d.call(h,{name:"text",hash:{},data:P}):d))+`</span>
</div>
`},useData:!0})},function(q,L,x){var v=x(6);q.exports=(v.default||v).template({1:function(h,R,W,P){return`    <p>
...
`},3:function(h,R,W,P){var d;return`    <p>
        The simplest way to do so is by creating a <code>&lt;label&gt;</code>
        tag with a <code>for</code> attribute like so:
    </p>

    <pre><code>&lt;label for="`+this.escapeExpression((d=(d=R.id||(h!=null?h.id:h))!=null?d:R.helperMissing,typeof d=="function"?d.call(h,{name:"id",hash:{},data:P}):d))+`"&gt;
    Label text here...
&lt;/label&gt;</code></pre>
`},5:function(h,R,W,P){var d;return`    <p>
    ...
    Label text here...
&lt;/label&gt;
&lt;`+this.escapeExpression((d=(d=R.tagName||(h!=null?h.tagName:h))!=null?d:R.helperMissing,typeof d=="function"?d.call(h,{name:"tagName",hash:{},data:P}):d))+` id="my-input"&gt;</code></pre>
    </p>
`},compiler:[6,">= 2.0.0-beta.1"],main:function(h,R,W,P){var d;return((d=R.if.call(h,h!=null?h.placeholder:h,{name:"if",hash:{},fn:this.program(1,P,0),inverse:this.noop,data:P}))!=null?d:"")+`
`+((d=R.if.call(h,h!=null?h.id:h,{name:"if",hash:{},fn:this.program(3,P,0),inverse:this.program(5,P,0),data:P}))!=null?d:"")},useData:!0})},function(q,L,x){var v=x(6);q.exports=(v.default||v).template({1:function(h,R,W,P){return`        <div class="tota11y-label-help">
            (<a class="tota11y-label-link" href="#">?</a>)
        </div>
`},compiler:[6,">= 2.0.0-beta.1"],main:function(h,R,W,P){var d,F,j=R.helperMissing,O="function";return`<span class="tota11y-label-error-icon">
    <!--
...
<span class="tota11y-label-content">
    <div class="tota11y-label-text">`+(F=(F=R.text||(h!=null?h.text:h))!=null?F:j,(d=typeof F===O?F.call(h,{name:"text",hash:{},data:P}):F)!=null?d:"")+`</div>
`+((d=R.if.call(h,h!=null?h.hasErrorEntry:h,{name:"if",hash:{},fn:this.program(1,P,0),inverse:this.noop,data:P}))!=null?d:"")+'    <div class="tota11y-label-detail">'+(F=(F=R.detail||(h!=null?h.detail:h))!=null?F:j,(d=typeof F===O?F.call(h,{name:"detail",hash:{},data:P}):F)!=null?d:"")+`</div>
</span>
`},useData:!0})},function(q,L,x){var v=x(6);q.exports=(v.default||v).template({compiler:[6,">= 2.0.0-beta.1"],main:function(h,R,W,P){var d,F;return`<li class="tota11y-info-error">
    ...
    <a href="#" class="tota11y-info-error-trigger tota11y-collapsed">
        <div class="tota11y-info-error-title">
            ...
            `+(F=(F=R.title||(h!=null?h.title:h))!=null?F:R.helperMissing,(d=typeof F=="function"?F.call(h,{name:"title",hash:{},data:P}):F)!=null?d:"")+`
        </div>
    </a>
...
`},useData:!0})},function(q,L,x){var v=x(6);q.exports=(v.default||v).template({compiler:[6,">= 2.0.0-beta.1"],main:function(h,R,W,P){return`<!--
...
`},function(q,L){q.exports=function(x){typeof execScript=="function"?execScript(x):eval.call(null,x)}},function(q,L,x){x(41)(x(40))},function(q,L,x){var v=x(22);typeof v=="string"&&(v=[[q.id,v,""]]),x(7)(v,{})},function(q,L,x){var v=x(23);typeof v=="string"&&(v=[[q.id,v,""]]),x(7)(v,{})},function(q,L,x){var v=x(24);typeof v=="string"&&(v=[[q.id,v,""]]),x(7)(v,{})},function(q,L,x){var v=x(25);typeof v=="string"&&(v=[[q.id,v,""]]),x(7)(v,{})},function(q,L,x){var v=x(26);typeof v=="string"&&(v=[[q.id,v,""]]),x(7)(v,{})},function(q,L,x){var v=x(27);typeof v=="string"&&(v=[[q.id,v,""]]),x(7)(v,{})},function(q,L,x){var v=x(28);typeof v=="string"&&(v=[[q.id,v,""]]),x(7)(v,{})}]);
